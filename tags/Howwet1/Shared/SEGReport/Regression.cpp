...
//---------------------------------------------------------------------------
void Regression::createFields(TDataSet* source, TDataSet* result)
   {
   string XFieldName = getProperty("XFieldName");
   string YFieldName = getProperty("YFieldName");
...
//---------------------------------------------------------------------------
void Regression::process(TDataSet* source, TDataSet* result)
   {
   string XFieldName = getProperty("XFieldName");
   string YFieldName = getProperty("YFieldName");
   if (XFieldName != "" && YFieldName != "")
