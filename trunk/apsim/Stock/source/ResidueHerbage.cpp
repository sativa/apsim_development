...
void ResidueHerbage::getParts(PlantPartType &parts, unsigned partsID)
{
...
void ResidueHerbage::getPGreen(PlantPartType &pGreen, PlantPool &dm)
{
      protocol::Variant* variant;
...
void ResidueHerbage::getPSenesced(PlantPartType &pSenesced, PlantPool &dm)
{
      protocol::Variant* variant;
...
void ResidueHerbage::getPDead(PlantPartType &pDead, PlantPool &dm)
{
      protocol::Variant* variant;
...
void ResidueHerbage::calcDmdDecline(void)
{
...
void ResidueHerbage::calcDmdClass(PlantPool &dmdClassMax, PlantPool &dmdClassMin)
{
...
void ResidueHerbage::calcDmdDistribution(PlantPool dmdFraction[], PlantPool dQ)
{
...
void ResidueHerbage::calcDmdDistributionB(PlantPool dmdFraction[], PlantPool dQ)
{
      PlantPool dmdDeclined = dmdMax - dQ;
...
float ResidueHerbage::proportionGreen ( void )
{
