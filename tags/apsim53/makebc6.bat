...
echo ------Compiling  %APSROOT%\Shared\general > %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out

cd %APSROOT%\Tools\def2imp
echo ------Compiling  %APSROOT%\Tools\def2imp >> %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out

cd %APSROOT%\Shared\ApsimShared
echo ------Compiling  %APSROOT%\Shared\ApsimShared >> %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out
...
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" ProcessDataTypesInterface.sln /build release >> %APSROOT%\build.win32.out

REM -------Compile RunMacro - needed to create ComponentInterface2/datatypes.h
cd %APSROOT%\tools\runmacro
echo ------Compiling RunMacro >> %APSROOT%\build.win32.out
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" RunMacro.sln /build release >> %APSROOT%\build.win32.out
...
echo ------Compiling  %APSROOT%\Shared\Protocol >> %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out

REM  ---- Has side effect of building datatypes.[cpp,h,f90] etc here
cd %APSROOT%\Shared\ComponentInterface
echo ------Compiling  %APSROOT%\Shared\ComponentInterface >> %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out
...
cd %APSROOT%\Shared\ComponentInterface2
echo ------Compiling  %APSROOT%\Shared\ComponentInterface2 >> %APSROOT%\build.win32.out
cmd /c %APSMAKE%  >> %APSROOT%\build.win32.out
...
call makefile.bat >> %APSROOT%\build.win32.out
