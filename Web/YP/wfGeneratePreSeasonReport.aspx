...
<%@ Page language="c#" Codebehind="wfGeneratePreSeasonReport.aspx.cs" AutoEventWireup="false" Inherits="YP2006.wfGeneratePreSeasonReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GeneratePre-Season Report</title>
			...
			<TABLE id="MainTable" style="WIDTH: 800px; HEIGHT: 488px" height="488" cellSpacing="0"
				...
				<TR>
					<TD style="WIDTH: 538px; HEIGHT: 522px" vAlign="top" align="left" colSpan="2">
						<DIV style="WIDTH: 802px; POSITION: relative; HEIGHT: 1220px" align="left" ms_positioning="GridLayout">
							...
							<DIV id="divPage" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 800px; POSITION: absolute; TOP: 64px; HEIGHT: 48px"
								...
								<asp:label id="lblHeading" style="Z-INDEX: 106; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
									Font-Names="Arial Black" Font-Size="Large" ForeColor="DarkGray" Font-Bold="True" Width="785px"
									Height="20px"> Generate Pre-Season Report</asp:label></DIV>
							<asp:panel id="pnlPaddock" style="Z-INDEX: 103; LEFT: 0px; POSITION: absolute; TOP: 176px"
							...
							<asp:label id="lblReportName" style="Z-INDEX: 104; LEFT: 32px; POSITION: absolute; TOP: 248px"
								runat="server" Font-Names="Arial" Width="272px" Height="16px">Enter a descriptive name for the report:</asp:label>
							<asp:textbox id="edtReportName" style="Z-INDEX: 105; LEFT: 32px; POSITION: absolute; TOP: 272px"
								tabIndex="1" runat="server" Font-Names="Arial" Width="528px" Height="24px"></asp:textbox>
							<asp:label id="lblCropOne" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: 560px"
								runat="server" Font-Names="Arial" Width="72px" Height="16px">Crop type:</asp:label>
							<asp:dropdownlist id="cboCropOne" style="Z-INDEX: 107; LEFT: 104px; POSITION: absolute; TOP: 560px"
								tabIndex="2" runat="server" Font-Names="Arial" Width="209px" Height="24px" AutoPostBack="True"></asp:dropdownlist>
							<asp:label id="lblNitrogen" style="Z-INDEX: 108; LEFT: 32px; POSITION: absolute; TOP: 320px"
								runat="server" Font-Names="Arial"> Nitrogen fertiliser applications:</asp:label>
							<jwg:gridex id=grdNitrogen style="Z-INDEX: 109; LEFT: 248px; POSITION: absolute; TOP: 320px" tabIndex=3 runat="server" Font-Names="Arial" Width="322px" Height="128px" GroupByBoxVisible="False" AllowEdit="True" GridLineColor="ScrollBar" DataSource="<%# dsNitrogen %>" DataMember="Nitrogen" ImagesFolderPath="/gridex/images" ScriptsFolderPath="/gridex/scripts" EditorsFrameUrl="/gridex/images/blank.html" UpdateMode="RowUpdateBatch" AutomaticSort="False" AllowColumnDrag="False" SendDataKeyValuesToClient="True">
							...
							<asp:label id="lblSowingDateOne" style="Z-INDEX: 110; LEFT: 40px; POSITION: absolute; TOP: 520px"
								runat="server" Font-Names="Arial" Width="160px" Height="16px"> Sowing date scenario:</asp:label>
							<jwg:gridex id=grdSowDateOne style="Z-INDEX: 111; LEFT: 200px; POSITION: absolute; TOP: 520px" tabIndex=4 runat="server" Font-Names="Arial" Width="120px" Height="20px" GroupByBoxVisible="False" AllowEdit="True" GridLineColor="ScrollBar" DataSource="<%# dsSowDate %>" DataMember="SowDateOne" ImagesFolderPath="/gridex/images" ScriptsFolderPath="/gridex/scripts" EditorsFrameUrl="/gridex/images/blank.html" UpdateMode="RowUpdateBatch" SendDataKeyValuesToClient="True" ColumnHeaders="False">
								<TotalRowFormatStyle BackColor="Window" Height="20px"></TotalRowFormatStyle>
								<GroupRowIndentJunctionFormatStyle BackColor="Control"></GroupRowIndentJunctionFormatStyle>
								<GroupIndentFormatStyle BackColor="Control"></GroupIndentFormatStyle>
								<NewRowFormatStyle BackColor="Window" ForeColor="WindowText" Height="20px"></NewRowFormatStyle>
							...
							<asp:label id="lblVarietyOne" style="Z-INDEX: 112; LEFT: 40px; POSITION: absolute; TOP: 600px"
								runat="server" Font-Names="Arial" Width="56px" Height="16px"> Variety:</asp:label>
							<asp:dropdownlist id="cboVarietyOne" style="Z-INDEX: 113; LEFT: 104px; POSITION: absolute; TOP: 600px"
								tabIndex="5" runat="server" Font-Names="Arial" Width="209px" Height="24px"></asp:dropdownlist>
							<asp:Panel id="pnlCanolaOne" style="Z-INDEX: 114; LEFT: 328px; POSITION: absolute; TOP: 480px"
							...
							<asp:label id="lblScenarioTwo" style="Z-INDEX: 115; LEFT: 112px; POSITION: absolute; TOP: 688px"
								runat="server" Font-Names="Arial" Font-Bold="True" Width="109px" Height="24px">Scenario Two</asp:label>
							<asp:label id="lblSowingDateTwo" style="Z-INDEX: 116; LEFT: 32px; POSITION: absolute; TOP: 720px"
								runat="server" Font-Names="Arial" Width="160px" Height="16px"> Sowing date scenario:</asp:label>
							<jwg:gridex id=grdSowDateTwo style="Z-INDEX: 117; LEFT: 192px; POSITION: absolute; TOP: 720px" tabIndex=6 runat="server" Font-Names="Arial" Width="120px" Height="20px" GroupByBoxVisible="False" AllowEdit="True" GridLineColor="ScrollBar" DataSource="<%# dsSowDate %>" DataMember="SowDateTwo" ImagesFolderPath="/gridex/images" ScriptsFolderPath="/gridex/scripts" EditorsFrameUrl="/gridex/images/blank.html" UpdateMode="RowUpdateBatch" SendDataKeyValuesToClient="True" ColumnHeaders="False">
								<TotalRowFormatStyle BackColor="Window" Height="20px"></TotalRowFormatStyle>
								<GroupRowIndentJunctionFormatStyle BackColor="Control"></GroupRowIndentJunctionFormatStyle>
								<GroupIndentFormatStyle BackColor="Control"></GroupIndentFormatStyle>
								<NewRowFormatStyle BackColor="Window" ForeColor="WindowText" Height="20px"></NewRowFormatStyle>
							...
							<asp:dropdownlist id="cboVarietyTwo" style="Z-INDEX: 118; LEFT: 96px; POSITION: absolute; TOP: 800px"
								tabIndex="7" runat="server" Font-Names="Arial" Width="209px" Height="24px"></asp:dropdownlist>
							<asp:label id="lblVarietyTwo" style="Z-INDEX: 119; LEFT: 32px; POSITION: absolute; TOP: 800px"
								runat="server" Font-Names="Arial" Width="56px" Height="16px"> Variety:</asp:label>
							<asp:Panel id="pnlCanolaTwo" style="Z-INDEX: 120; LEFT: 328px; POSITION: absolute; TOP: 688px"
								runat="server" Width="456px" Height="200px" Visible="False">
								<DIV title="Canola" style="WIDTH: 456px; POSITION: relative; HEIGHT: 184px" ms_positioning="GridLayout">
									<asp:checkbox id="chkTriazineTwo" style="Z-INDEX: 115; LEFT: 8px; POSITION: absolute; TOP: 8px"
										runat="server" Font-Names="Arial" Height="20px" Width="160px" Text="Triazine tolerant?" TextAlign="Left"></asp:checkbox></DIV>
							</asp:Panel>
							<asp:label id="lblScenarioThree" style="Z-INDEX: 121; LEFT: 112px; POSITION: absolute; TOP: 896px"
								runat="server" Font-Names="Arial" Font-Bold="True" Width="128px" Height="24px">Scenario Three</asp:label>
							<asp:label id="lblSowingDateThree" style="Z-INDEX: 122; LEFT: 32px; POSITION: absolute; TOP: 936px"
								runat="server" Font-Names="Arial" Width="160px" Height="16px"> Sowing date scenario:</asp:label>
							<jwg:gridex id=grdSowDateThree style="Z-INDEX: 123; LEFT: 200px; POSITION: absolute; TOP: 936px" tabIndex=8 runat="server" Font-Names="Arial" Width="120px" Height="20px" GroupByBoxVisible="False" AllowEdit="True" GridLineColor="ScrollBar" DataSource="<%# dsSowDate %>" DataMember="SowDateThree" ImagesFolderPath="/gridex/images" ScriptsFolderPath="/gridex/scripts" EditorsFrameUrl="/gridex/images/blank.html" UpdateMode="RowUpdateBatch" SendDataKeyValuesToClient="True" ColumnHeaders="False">
								<TotalRowFormatStyle BackColor="Window" Height="20px"></TotalRowFormatStyle>
								<GroupRowIndentJunctionFormatStyle BackColor="Control"></GroupRowIndentJunctionFormatStyle>
								<GroupIndentFormatStyle BackColor="Control"></GroupIndentFormatStyle>
								<NewRowFormatStyle BackColor="Window" ForeColor="WindowText" Height="20px"></NewRowFormatStyle>
							...
							<asp:dropdownlist id="cboVarietyThree" style="Z-INDEX: 124; LEFT: 96px; POSITION: absolute; TOP: 1016px"
								tabIndex="9" runat="server" Font-Names="Arial" Width="210px" Height="24px"></asp:dropdownlist>
							<asp:label id="lblVarietyThree" style="Z-INDEX: 125; LEFT: 32px; POSITION: absolute; TOP: 1016px"
								runat="server" Font-Names="Arial" Width="56px" Height="16px"> Variety:</asp:label>
							<asp:Panel id="pnlSorgumThree" style="Z-INDEX: 126; LEFT: 328px; POSITION: absolute; TOP: 896px"
								runat="server" Width="456px" Height="200px" Visible="False">
							...
							<asp:label id="lblScenarioOne" style="Z-INDEX: 127; LEFT: 128px; POSITION: absolute; TOP: 480px"
								runat="server" Font-Names="Arial" Font-Bold="True" Width="104px" Height="24px">Scenario One</asp:label>
							<asp:panel id="pnlSorgumOne" style="Z-INDEX: 128; LEFT: 328px; POSITION: absolute; TOP: 480px"
								runat="server" Width="456px" Height="200px" Visible="False">
							...
							<asp:Panel id="pnlSorgumTwo" style="Z-INDEX: 129; LEFT: 328px; POSITION: absolute; TOP: 688px"
								runat="server" Width="456px" Height="200px" Visible="False">
								<DIV title="Sorgum" style="WIDTH: 457px; POSITION: relative; HEIGHT: 184px" ms_positioning="GridLayout">
							...
							<asp:Panel id="pnlCanolaThree" style="Z-INDEX: 130; LEFT: 328px; POSITION: absolute; TOP: 896px"
								runat="server" Width="456px" Height="200px" Visible="False">
								<DIV title="Canola" style="WIDTH: 456px; POSITION: relative; HEIGHT: 184px" ms_positioning="GridLayout">
									<asp:checkbox id="chkTriazineThree" style="Z-INDEX: 115; LEFT: 8px; POSITION: absolute; TOP: 8px"
										runat="server" Font-Names="Arial" Height="20px" Width="160px" Text="Triazine tolerant?" TextAlign="Left"></asp:checkbox></DIV>
							</asp:Panel>
							<asp:Button id="btnGenerate" style="Z-INDEX: 131; LEFT: 256px; POSITION: absolute; TOP: 1120px"
								tabIndex="10" runat="server" Font-Names="Arial" Width="120px" Height="32px" Text="Generate"></asp:Button>
							<asp:Button id="btnCancel" style="Z-INDEX: 132; LEFT: 416px; POSITION: absolute; TOP: 1120px"
								tabIndex="11" runat="server" Font-Names="Arial" Width="120px" Height="32px" Text="Cancel"></asp:Button>
							<asp:CheckBox id="chkFavourite" style="Z-INDEX: 133; LEFT: 320px; POSITION: absolute; TOP: 1160px"
								tabIndex="12" runat="server" Font-Names="Arial" ForeColor="Black" Text="Save as favourite?"
								TextAlign="Left"></asp:CheckBox>
							<asp:Panel id="pnlBottomBorder" style="Z-INDEX: 134; LEFT: 0px; POSITION: absolute; TOP: 1200px"
								runat="server" Width="800px" Height="16px" BackColor="MediumBlue"></asp:Panel>
							<asp:Image id="imgBanner" style="Z-INDEX: 135; LEFT: 72px; POSITION: absolute; TOP: 8px" runat="server"
								Width="120px" Height="56px" ImageUrl="BannerImages\defaultlogo.jpg"></asp:Image>
							<asp:label id="lblCropTwo" style="Z-INDEX: 136; LEFT: 16px; POSITION: absolute; TOP: 760px"
								runat="server" Font-Names="Arial" Width="72px" Height="16px">Crop type:</asp:label>
							<asp:dropdownlist id="cboCropTwo" style="Z-INDEX: 137; LEFT: 96px; POSITION: absolute; TOP: 760px"
								tabIndex="2" runat="server" Font-Names="Arial" Width="209px" Height="24px" AutoPostBack="True"></asp:dropdownlist>
							<asp:label id="lblCropThree" style="Z-INDEX: 139; LEFT: 16px; POSITION: absolute; TOP: 976px"
								runat="server" Font-Names="Arial" Width="72px" Height="16px">Crop type:</asp:label>
							<asp:dropdownlist id="cboCropThree" style="Z-INDEX: 140; LEFT: 96px; POSITION: absolute; TOP: 976px"
								tabIndex="2" runat="server" Font-Names="Arial" Width="209px" Height="24px" AutoPostBack="True"></asp:dropdownlist></DIV>
					</TD>
				</TR>
			</TABLE>
		</form>
