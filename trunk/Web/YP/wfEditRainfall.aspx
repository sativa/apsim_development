...
<DIV style="WIDTH: 288px; POSITION: relative; HEIGHT: 40px" 
ms_positioning="GridLayout">
<asp:LinkButton id=btnCancel style="Z-INDEX: 100; LEFT: 104px; POSITION: absolute; TOP: 16px" runat="server" EnableViewState="False" Font-Size="X-Small">Cancel</asp:LinkButton>
<asp:Button id=btnSave style="Z-INDEX: 105; LEFT: 32px; POSITION: absolute; TOP: 16px" runat="server" Width="32px" Height="16px" BackColor="Transparent" Font-Size="Smaller" Font-Underline="True" ForeColor="Purple" BorderColor="Transparent" BorderStyle="None" Text="Save"></asp:Button>
<asp:ImageButton id=btnCancelImg style="Z-INDEX: 101; LEFT: 80px; POSITION: absolute; TOP: 16px" runat="server" ImageUrl="Images\cancel.gif"></asp:ImageButton>
...
<asp:Label id=lblYear style="Z-INDEX: 104; LEFT: 176px; POSITION: absolute; TOP: 16px" runat="server" Width="32px" Font-Size="Smaller" Font-Underline="True" ForeColor="Purple"> Year:</asp:Label>
<asp:DropDownList id=cboYear style="Z-INDEX: 103; LEFT: 208px; POSITION: absolute; TOP: 16px" runat="server" Width="64px" AutoPostBack="True">
			...
			</asp:panel><jwg:gridex id=grdRainfall style="Z-INDEX: 102; LEFT: 16px; POSITION: absolute; TOP: 64px" runat="server" Height="501px" Width="522px" ScriptsFolderPath="/gridex/scripts" ImagesFolderPath="/gridex/images" GridLineColor="ScrollBar" AllowEdit="True" DataSource="<%# dsRainfall %>" DataMember="Rainfall" GroupByBoxVisible="False" TotalRow="True" SendDataKeyValuesToClient="True" UpdateMode="RowUpdateBatch">
 ...
 Caption="Dec" Width="40px" AggregateFunction="Sum">
			...
			<asp:Label id="lblTotalRainfall" style="Z-INDEX: 103; LEFT: 200px; POSITION: absolute; TOP: 576px"
				runat="server" Width="285px" Height="16px">Total rainfall for the year from the 1st of April:</asp:Label>
			<asp:TextBox id="edtTotalRainfall" style="Z-INDEX: 104; LEFT: 480px; POSITION: absolute; TOP: 576px"
				runat="server" Width="56px" ReadOnly="True" Height="18px"></asp:TextBox></form>
	</body>
</HTML>
