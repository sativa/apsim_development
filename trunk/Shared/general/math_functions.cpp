...
void Minim (vector<double>& param,
            ...
            TOptimEvent f)
   {
      ...
      double H[22];
      double PBAR[21];
      vector<double> PSTAR(21, 0.0);
      vector<double> PSTST(21, 0.0);
//      double AVAL[21];
//      double BMAT[211];
//      double PMIN[21];
//      double VC[211];
...
L410:  for (I=0;I<NOP;I++)
         {
         if(step[I]==ZERO) continue;
         param[I]=ZERO;
         for (J=0;J<NP1;J++)
            param[I]=param[I]+G[J][I];
         FNP1 = NP1;
         param[I]=param[I]/FNP1;
         }
