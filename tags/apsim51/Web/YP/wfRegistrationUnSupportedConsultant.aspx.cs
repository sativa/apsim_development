...
{
	/// <summary>
	/// Summary description for wfRegistrationUnSupportedConsultant.
	/// </summary>
	public class wfRegistrationUnSupportedConsultant : System.Web.UI.Page
	{
		...
		public string ReturnEmailBody()
		{
			string szBody = RegistrationClass.ReturnEmailBody(edtFirstName.Text, edtSecondName.Text, null, edtPostalAddressOne.Text,
				...
				edtMobile.Text, edtFax.Text, edtEmail.Text, null, null, null, null, "Un-Supported Consultant");
			return szBody;
		}
		#endregion
		...
		{
			Server.Transfer("wfRegistrationUnSupportedConsultantGrowers.aspx");
		}
		//---------------------------------------------------------------------
		//
		//---------------------------------------------------------------------
