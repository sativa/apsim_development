...
extern const char *no_section;


extern const char *ACTION_Create;
extern const char *ACTION_Init;
extern const char *ACTION_Get_variable;
extern const char *ACTION_Set_variable;
extern const char *ACTION_Prepare;
extern const char *ACTION_Process;
extern const char *ACTION_Post;
extern const char *ACTION_Start;
extern const char *ACTION_Pause;
extern const char *ACTION_Continue;
extern const char *ACTION_Finish;
extern const char *ACTION_End_Run;
extern const char *ACTION_Report;
extern const char *ACTION_Idle;
extern const char *ACTION_Reset;
extern const char *ACTION_Sum_Report;
extern const char *ACTION_Till;
extern const char *ACTION_Sow;
extern const char *ACTION_Harvest;
extern const char *ACTION_End_Crop;
extern const char *ACTION_Kill_Crop;
extern const char *ACTION_Incorp_FOM;
extern const char *ACTION_Add_Residue;
extern const char *ACTION_Do_Decompose;
extern const char *ACTION_Decomposed;
extern const char *ACTION_Initiate_Crop;
extern const char *ACTION_Add_Residue_P;
...
// ====================================================================
extern const char *DATA_sender;      // keyname used to identify the sender
                                      // of an event.  This data is included
                                      // with every event.

extern const char *DATA_sender_ID;// ID used to identify the sender
                                      // of an event.  This data is included
                                      // with every event.
extern const char *EVENT_tick;

extern const char *DATA_day;             // data name for day of year
extern const char *DATA_year;           // data name for year
extern const char *DATA_jday;           // data name for julian day number
extern const char *DATA_time;           // data name for time of day
extern const char *DATA_timestep;   // data name for timestep
extern const char *EVENT_new_solute;
extern const char *DATA_new_solute_names;  // name of character array of data containing
                                                     // a list of solutes owned by the sender
extern const char *EVENT_newmet;
extern const char *DATA_radn;
extern const char *DATA_maxt;
extern const char *DATA_mint;
extern const char *DATA_rain;
extern const char *DATA_vp;
extern const char *EVENT_irrigated;
extern const char *DATA_irrigate_amount;
extern const char *DATA_irrigate_time;
extern const char *DATA_irrigate_duration;
extern const char *EVENT_Pot_Res_decomp;
extern const char *DATA_Pot_C_decomp;
extern const char *DATA_Pot_n_decomp;
extern const char *DATA_Pot_P_decomp;
extern const char *EVENT_n_Balance;
extern const char *DATA_NH4_transform_net;
extern const char *DATA_NO3_transform_net;
extern const char *DATA_dlt_NH4_net;
extern const char *DATA_dlt_NO3_net;
extern const char *EVENT_C_Balance;
extern const char *DATA_dlt_OC;
extern const char *DATA_dlt_OM;
extern const char *EVENT_Residue_added;
extern const char *DATA_residue_type;
extern const char *DATA_dlt_residue_wt;
extern const char *EVENT_Residue_removed;
extern const char *DATA_residue_removed_action ;
extern const char *DATA_dlt_residue_fraction;
extern const char *DATA_residue_incorp_fraction;
extern const char *EVENT_Crop_chopped;

//   Event Data

extern const char *DATA_crop_type ;
extern const char *DATA_dm_type ;
extern const char *DATA_dlt_crop_dm ;
extern const char *DATA_fraction_to_Residue ;
extern const char *DATA_dlt_dm_n ;
extern const char *DATA_dlt_dm_cnr ;
extern const char *DATA_dlt_dm_p ;
extern const char *DATA_dlt_dm_cpr ;

extern const char *EVENT_New_Profile;
extern const char *DATA_dlayer;
extern const char *DATA_air_dry_dep;
extern const char *DATA_ll15_dep;
extern const char *DATA_dul_dep;
extern const char *DATA_sat_dep;
extern const char *DATA_sw_dep;
extern const char *DATA_bd;
...
//extern "C" void _stdcall _export crop_root_length_init (int *stage_to_init,
//      float *g_current_stage, float *g_days_tot, float *root_wt,
//      float *c_specific_root_length, float *g_root_depth, float *g_dlayer,
//      float *g_root_length, int *max_layer);
...
//extern "C" void _stdcall _export cproc_root_depth1 (float *G_dlayer,
//      int *C_num_sw_ratio, float *C_x_sw_ratio, float *C_y_sw_fac_root,
//      float *G_dul_dep, float *G_sw_dep, float *P_ll_dep, float *C_root_depth_rate,
//      float *G_current_stage, float *P_xf, float *G_dlt_root_depth, float *G_root_depth);

//void crop_root_depth_increase(float *C_root_depth_rate,
//     float *G_current_stage, float *G_dlayer, float *G_root_depth,
//      float *G_sw_avail_fac_deepest_layer, float *P_xf, float *dlt_root_depth);
...
//extern "C" void search_read_char_array(const char* search_order[],
//                                       int* num_sections,
//                                     const char* key,
//                                     int* max_values,
//                                     const char* units,
...
inline void crop_get_ext_uptakes (const char * uptake_source,
         const char *crop_type, const char *uptake_type, float unit_conversion_factor,
         float uptake_lbound, float uptake_ubound, float *uptake_array,
         const int max_layer) {
     crop_get_ext_uptakes( uptake_source, crop_type, uptake_type, &unit_conversion_factor,
                           &uptake_lbound, &uptake_ubound, uptake_array, &max_layer);
};
