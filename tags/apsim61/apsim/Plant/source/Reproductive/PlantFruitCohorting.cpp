...
PlantFruitCohorting::PlantFruitCohorting(ScienceAPI& scienceAPI, plantInterface *p, const string &name)
   ...
   // ====================================================================
{
   ...
   cohort = new FruitCohortFN(scienceAPI, plant, cohortName.str());
