...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Label id="lblFurtherDetails" style="Z-INDEX: 113; LEFT: 168px; POSITION: absolute; TOP: 328px"
			...
			<asp:Label id="lblVisiting" style="Z-INDEX: 107; LEFT: 168px; POSITION: absolute; TOP: 216px"
				runat="server" Height="32px" Width="112px" ForeColor="Blue">Just Visiting?</asp:Label>
			<asp:Label id="lblVisitingDetail" style="Z-INDEX: 108; LEFT: 168px; POSITION: absolute; TOP: 264px"
			...
			<asp:Label id="lblWarningTwo" style="Z-INDEX: 109; LEFT: 168px; POSITION: absolute; TOP: 400px"
			...
			<asp:Label id="lblWarningOne" style="Z-INDEX: 110; LEFT: 168px; POSITION: absolute; TOP: 368px"
				runat="server" Height="32px" Width="248px" Font-Bold="True">Important notice to users:</asp:Label>
			<asp:HyperLink id="hylWarning" style="Z-INDEX: 111; LEFT: 168px; POSITION: absolute; TOP: 480px"
			...
			<asp:HyperLink id="hylEmail" style="Z-INDEX: 114; LEFT: 336px; POSITION: absolute; TOP: 328px"
