...
void ControlFileConverter::go(const string& fileName)
   ...
   if (scriptFileNames.size() > 0)
      {
      cout << "The APSIM control file: " + fileName + " will be automatically upgraded to the" << endl;
      cout << "new version. The original con/par and man files will be given new extensions of " << endl;
