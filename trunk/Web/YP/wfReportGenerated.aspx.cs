...
namespace YieldProphet
{
	...
	public class wfReportGenerated : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
			...
			if (!FunctionsClass.IsSampleSWValid(Session["SelectedPaddockName"].ToString(),
				                               Session["SelectedUserName"].ToString()))
				{
				FunctionsClass.DisplayMessage(Page, "Your soil water values on the setting up page do not match your " +
					                                "chosen soil type. Your report has still " +
													"been generated. Please contact James Hunt.");
				EmailClass.SendEmail("james.hunt@aanet.com.au", "Dean.Holzworth@csiro.au", "Invalid sw values in YP",
					                 "Autogenerated email from YP.\r\n " +
					                 "User name: " + Session["UserName"].ToString() + ".\r\n " +
					                 "Grower name: " + Session["SelectedUserName"].ToString() + ".\r\n " +
									 "Paddock name: " + Session["SelectedPaddockName"].ToString(),
									 null,  System.Web.Mail.MailPriority.Normal); 
				}
