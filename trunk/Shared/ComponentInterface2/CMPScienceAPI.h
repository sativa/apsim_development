...
class EXPORT CMPScienceAPI : public ScienceAPI
   ...
   public:
      ...
      virtual void subscribe(const std::string& name, boost::function1<void, SoilNitrogenFlowsLayerType&> handler);
      virtual void publish(const std::string& name, SoilNitrogenFlowsLayerType& data);

      virtual void subscribe(const std::string& name, boost::function1<void, NitrogenBalanceType&> handler);
      virtual void publish(const std::string& name, NitrogenBalanceType& data);
