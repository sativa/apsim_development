...
// constructor
//---------------------------------------------------------------------------
__fastcall TChartLine::TChartLine(TComponent* owner)
   : TSEGTable(owner)
   {
   }
...
// destructor
//---------------------------------------------------------------------------
__fastcall TChartLine::~TChartLine()
   {
   }
//---------------------------------------------------------------------------
// Set the fieldName property.
//---------------------------------------------------------------------------
void __fastcall TChartLine::setFieldName(AnsiString fieldName)
   {
...
// Set the x1 property.
//---------------------------------------------------------------------------
void __fastcall TChartLine::setX1(float x1)
   {
   if (X1 != x1)
      {
      X1 = x1;
...
// Set the x2 property.
//---------------------------------------------------------------------------
void __fastcall TChartLine::setX2(float x2)
   {
   if (X2 != x2)
      {
      X2 = x2;
...
//---------------------------------------------------------------------------
void __fastcall TChartLine::setLabel(AnsiString label)
   {
   if (Label != label)
      {
      Label = label;
...
//---------------------------------------------------------------------------
bool TChartLine::createFields(void) throw(runtime_error)
   {
...
//---------------------------------------------------------------------------
void TChartLine::storeRecords(void) throw(runtime_error)
   {
   if (source != NULL && FieldName != "")
      {
