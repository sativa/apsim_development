...
namespace YP2006
{
	...
	public class wfGenerateIrrigationComparisonReport : System.Web.UI.Page
	{
		...
		protected System.Data.DataTable dtIrrigationOne;
		protected System.Data.DataTable dtIrrigationTwo;
		protected System.Data.DataTable dtIrrigationThree;
		protected System.Data.DataColumn dcIrrigationIDOne;
		protected System.Data.DataColumn dtIrrigationDateOne;
		protected System.Data.DataColumn dtIrrigationAmountOne;
		protected System.Data.DataColumn dcIrrigationEfficencyOne;
		protected System.Data.DataColumn dcIrrigationIDTwo;
		protected System.Data.DataColumn dtIrrigationDateTwo;
		protected System.Data.DataColumn dtIrrigationAmountTwo;
		protected System.Data.DataColumn dcIrrigationEfficencyTwo;
		protected System.Data.DataColumn dcIrrigationIDThree;
		protected System.Data.DataColumn dtIrrigationDateThree;
		protected System.Data.DataColumn dtIrrigationAmountThree;
		protected System.Data.DataColumn dcIrrigationEfficencyThree;
		...
		private static string szReportType = "Irrigation comparison report";
		...
		{    
			...
			this.dtIrrigationOne = new System.Data.DataTable();
			this.dcIrrigationIDOne = new System.Data.DataColumn();
			this.dtIrrigationDateOne = new System.Data.DataColumn();
			this.dtIrrigationAmountOne = new System.Data.DataColumn();
			this.dcIrrigationEfficencyOne = new System.Data.DataColumn();
			this.dtIrrigationTwo = new System.Data.DataTable();
			this.dcIrrigationIDTwo = new System.Data.DataColumn();
			this.dtIrrigationDateTwo = new System.Data.DataColumn();
			this.dtIrrigationAmountTwo = new System.Data.DataColumn();
			this.dcIrrigationEfficencyTwo = new System.Data.DataColumn();
			this.dtIrrigationThree = new System.Data.DataTable();
			this.dcIrrigationIDThree = new System.Data.DataColumn();
			this.dtIrrigationDateThree = new System.Data.DataColumn();
			this.dtIrrigationAmountThree = new System.Data.DataColumn();
			this.dcIrrigationEfficencyThree = new System.Data.DataColumn();
			...
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationOne)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationTwo)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationThree)).BeginInit();
			...
			this.dsIrrigation.Tables.AddRange(new System.Data.DataTable[] {
																			  this.dtIrrigationOne,
																			  this.dtIrrigationTwo,
																			  this.dtIrrigationThree});
			// 
			// dtIrrigationOne
			// 
			this.dtIrrigationOne.Columns.AddRange(new System.Data.DataColumn[] {
																				   this.dcIrrigationIDOne,
																				   this.dtIrrigationDateOne,
																				   this.dtIrrigationAmountOne,
																				   this.dcIrrigationEfficencyOne});
			this.dtIrrigationOne.TableName = "IrrigationOne";
			// 
			// dcIrrigationIDOne
			// 
			this.dcIrrigationIDOne.ColumnName = "ID";
			// 
			// dtIrrigationDateOne
			// 
			this.dtIrrigationDateOne.ColumnName = "Date";
			this.dtIrrigationDateOne.DataType = typeof(System.DateTime);
			// 
			// dtIrrigationAmountOne
			// 
			this.dtIrrigationAmountOne.ColumnName = "Amount";
			// 
			// dcIrrigationEfficencyOne
			// 
			this.dcIrrigationEfficencyOne.ColumnName = "Efficency";
			// 
			// dtIrrigationTwo
			// 
			this.dtIrrigationTwo.Columns.AddRange(new System.Data.DataColumn[] {
																				   this.dcIrrigationIDTwo,
																				   this.dtIrrigationDateTwo,
																				   this.dtIrrigationAmountTwo,
																				   this.dcIrrigationEfficencyTwo});
			this.dtIrrigationTwo.TableName = "IrrigationTwo";
			// 
			// dcIrrigationIDTwo
			// 
			this.dcIrrigationIDTwo.ColumnName = "ID";
			// 
			// dtIrrigationDateTwo
			// 
			this.dtIrrigationDateTwo.ColumnName = "Date";
			this.dtIrrigationDateTwo.DataType = typeof(System.DateTime);
			// 
			// dtIrrigationAmountTwo
			// 
			this.dtIrrigationAmountTwo.ColumnName = "Amount";
			// 
			// dcIrrigationEfficencyTwo
			// 
			this.dcIrrigationEfficencyTwo.ColumnName = "Efficency";
			// 
			// dtIrrigationThree
			// 
			this.dtIrrigationThree.Columns.AddRange(new System.Data.DataColumn[] {
																					 this.dcIrrigationIDThree,
																					 this.dtIrrigationDateThree,
																					 this.dtIrrigationAmountThree,
																					 this.dcIrrigationEfficencyThree});
			this.dtIrrigationThree.TableName = "IrrigationThree";
			// 
			// dcIrrigationIDThree
			// 
			this.dcIrrigationIDThree.ColumnName = "ID";
			// 
			// dtIrrigationDateThree
			// 
			this.dtIrrigationDateThree.ColumnName = "Date";
			this.dtIrrigationDateThree.DataType = typeof(System.DateTime);
			// 
			// dtIrrigationAmountThree
			// 
			this.dtIrrigationAmountThree.ColumnName = "Amount";
			// 
			// dcIrrigationEfficencyThree
			// 
			this.dcIrrigationEfficencyThree.ColumnName = "Efficency";
			// 
			// dsNitrogen
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationOne)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationTwo)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dtIrrigationThree)).EndInit();
		...
		private void InitialiseEmptyForm()
		{
			...
			FunctionsClass.InitialiseApplicationGrid(dsIrrigation, 10, this);
		}
		//-------------------------------------------------------------------------
		//
		//-------------------------------------------------------------------------
		...
		private void FillFormFromFavouriteXML()
		{
			...
			DataTable dtIrrigationApps = DataAccessClass.GetPaddocksIrrigationApplications( 
				((DataTable)ViewState["Paddocks"]).Rows[0]["PaddockName"].ToString(), 
				((DataTable)ViewState["Paddocks"]).Rows[0]["UserName"].ToString());

			int iIrrigationLimit = dtIrrigationApps.Rows.Count;
			...
			foreach(XmlNode xmlUpperChild in xmlScenario.ChildNodes)
			{
				...
				{	
					switch(xmlChildNode.Name)
					{
						case "irrigate":
							iIrrigationCount++;
							if(iIrrigationCount > iIrrigationLimit)
								FunctionsClass.AddIrrigationNodeToIrrigationDataSet(iScenarioCount-1, 
									xmlChildNode, dsIrrigation);
							break;
						case "fertilise":
							iNitrogenCount++;
				...
				if(szReportName != "")
					...
					if(InputValidationClass.IsInputAValidFileLocationString(szReportName) == true)
						...
						for(int iIndex = 0; iIndex < dtPaddocks.Rows.Count; iIndex++)
							...
							string szReportXML = 
								ReportClass.PrepareIrrigationComparisonXML(szNewReportName, szReportType,
