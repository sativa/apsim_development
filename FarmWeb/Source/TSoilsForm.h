...
//---------------------------------------------------------------------------
class TSoilsForm: public TIWAppForm
   {
   ...
   void __fastcall DeleteSoilButtonClick(TObject *Sender);
   ...
   private:
      ...
      //---------------------------------------------------------------------------
      void __fastcall deleteSoilCallback(bool yesClicked);


   public:
      __fastcall TSoilsForm(TComponent* Owner);
