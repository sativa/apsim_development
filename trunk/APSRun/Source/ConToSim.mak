...
RESDEPEN = $(RESFILES)
LIBFILES = ..\..\Shared\ApsimShared\ApsimShared.lib
IDLFILES = 
IDLGENFILES = 
LIBRARIES = TMSC6.lib
...
INCLUDEPATH = $(BCB)\include;$(BCB)\include\vcl;$(BCB)\Components\ThirdParty;$(BCB)\Components\tms;$(SHARED)
LIBPATH = D:\development\APSRun\Source;$(BCB)\lib\obj;$(BCB)\lib;$(BCB)\Components\tms;$(BCB)\Components\thirdparty
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
