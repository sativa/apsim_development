...
<%@ Page language="c#" Codebehind="wfRegistrationSupportedConsultant.aspx.cs" AutoEventWireup="false" Inherits="YP2006.wfRegistrationSupportedConsultant" %>
						...
						<DIV style="WIDTH: 801px; POSITION: relative; HEIGHT: 755px" align="left" ms_positioning="GridLayout">
							...
							<DIV id="divPage" style="Z-INDEX: 101; LEFT: 0px; WIDTH: 800px; POSITION: absolute; TOP: 48px; HEIGHT: 48px"
								...
								<asp:label id="lblHeading" style="Z-INDEX: 106; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
									...
									Height="20px">Yield Prophet<sup>®</sup> 2006 - Supported Consultant Registration & Delivery Information</asp:label></DIV>
							...
							<jwge:IntegerUpDown id="edtNumberOfGrowers" style="Z-INDEX: 112; LEFT: 528px; POSITION: absolute; TOP: 536px"
							...
							<asp:Label id="Label1" style="Z-INDEX: 114; LEFT: 16px; POSITION: absolute; TOP: 528px" runat="server"
								Font-Names="Arial" Width="488px">How many growers would you like to subscribe (each grower $220 for the first paddock and $110 a paddock thereafter):</asp:Label>
							...
							<asp:Label id="Label6" style="Z-INDEX: 119; LEFT: 16px; POSITION: absolute; TOP: 592px" runat="server"
