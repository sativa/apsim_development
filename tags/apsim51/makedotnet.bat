...
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" apsimui.sln /rebuild debug >> %APSROOT%\dotnet.out
cd %APSROOT%

rem --------- Compile apsoil
cd %APSROOT%\apsoil\source
echo ------Compiling apsoil >> %APSROOT%\dotnet.out
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" apsoil.sln /rebuild debug >> %APSROOT%\dotnet.out
cd %APSROOT%
...
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" GetComponentDescription.csproj /rebuild debug >> %APSROOT%\build.out
cd %APSROOT%
...
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" Slurp.vbproj /rebuild debug >> %APSROOT%\dotnet.out
cd %APSROOT%

rem --------- Compile ApsimToSim Module
cd %APSROOT%\apsrun\ApsimToSim
echo ------Compiling ApsimToSim >> %APSROOT%\dotnet.out
"C:\Program Files\Microsoft Visual Studio 8\Common7\IDE\devenv" ApsimToSim.csproj /rebuild debug >> %APSROOT%\dotnet.out
cd %APSROOT%