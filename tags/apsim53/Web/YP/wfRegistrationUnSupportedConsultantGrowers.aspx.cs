...
{
	/// <summary>
	/// Summary description for wfRegistrationUnSupportedConsultantGrowers.
	/// </summary>
	public class wfRegistrationUnSupportedConsultantGrowers : System.Web.UI.Page
	{
		...
		private void SetNumberOfGrowers()
		{
			try
			{
				...
				if("ASP.wfRegistrationUnSupportedConsultant_aspx" == szPreviousPage)
				{
					wfRegistrationUnSupportedConsultant PremiumConsultant = (wfRegistrationUnSupportedConsultant) HttpContext.Current.Handler;
		...
		private void SetHeading()
		{
			...
			lblNumberOfPaddocks.Text = "How many paddocks would you like to subscribe to Grower "+
				...
				" (one paddock is included in subscription fee, extra paddocks are $55 each):";
