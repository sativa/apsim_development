...
<%@ Page language="c#" Codebehind="wfRegistrationUnSupportedConsultantGrowers.aspx.cs" AutoEventWireup="false" Inherits="YP2006.wfRegistrationUnSupportedConsultantGrowers" %>
					...
					<TD style="WIDTH: 774px; HEIGHT: 522px" vAlign="top" align="left" colSpan="2">
						<DIV style="WIDTH: 801px; POSITION: relative; HEIGHT: 984px" align="left" ms_positioning="GridLayout">
							...
							<asp:Label id="lblNumberOfPaddocks" style="Z-INDEX: 113; LEFT: 16px; POSITION: absolute; TOP: 544px"
								runat="server" Font-Names="Arial" Width="544px">How many paddocks would you like to subscribe (one paddock is included in subscription fee, extra paddocks are $55 each):</asp:Label>
