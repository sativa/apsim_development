...
//- Implementation Section ----------------------------------
      ...
      dm_grain_demand = grainPart->dm_yield_demand();            //FIXME throughout - dm_grain_demand should be gDlt_dm_grain_demand. Leave asis for compatability
...
//JNGH to replace old code          t != myParts.end();
//JNGH to replace old code          t++)
//JNGH to replace old code        (*t)->dm_partition1 (g_dlt_dm, dm_demand);
//JNGH to replace old code
...
void PlantFruit::dm_partition2 (double g_dlt_dm)               //FIXME this to go - dm_partition1 can do the lot when fracPod moved to pod.
//     ===========================================================
{
//       Partitions new dm (assimilate) between plant components (g/m^2)
...
// this is different for each stage
    ...
    if (grainPart->dmDemandDifferential() > 0.0)
    {
        ...
        dm_grain_demand_differential    = grainPart->dmYieldDemandDifferential();      //FIXME
...
void PlantFruit::dm_retranslocate2( float  g_dlt_dm_retrans_to_fruit)        // Fixme - this code should disappear is fracPod is sorted out
//     ===========================================================
{
