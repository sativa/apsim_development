...
cejvo
     ...
     :                              , max_stage)
      ...
      elseif (variable_name .eq. 'leaf_no_ref') then
         call respond2get_real_var (variable_name
     :                              , '()'
     :                              , g_leaf_no_ref)                            
...
*     millet_dm_init
*     millet_dm_partition
*     millet_dm_production
*     millet_dm_retranslocate
*     millet_dm_stress_max
*     millet_grain_no
*     millet_heat_stress
*     pop_routine
*     push_routine
...
*   Calls:
*     millet_dm_detachment
*     millet_N_detachment
*     millet_N_senescence
*     millet_slai_detachment
*     pop_routine
*     push_routine
...
*     push_routine
*     millet_dm_dead_detachment
*     millet_N_dead_detachment
*     millet_tlai_dead_detachment
*     millet_plants
...
*   Calls:
*     millet_dm_senescence
*     millet_lai_equilib_light
*     millet_lai_equilib_water
*     millet_leaf_area_sen
*     millet_leaf_death
*     millet_N_senescence
*     pop_routine
*     push_routine
...
*   Global variables
      ...
      real       divide                ! function
      integer    offset_day_of_year    ! function
      real       sum_part_of_real      ! function
...
*   Calls:
*     fatal_error
*     millet_tiller_appearance_dm
*     millet_tiller_appearance_tt
*     pop_routine
*     push_routine
...
*     u_bound
!
! gol added call to day_length and on_day_of
*     day_length
*     divide
*     on_day_of
*     pop_routine
