...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Label id="Label1" style="Z-INDEX: 115; LEFT: 168px; POSITION: absolute; TOP: 368px" runat="server"
				Height="24px" Width="184px" ForeColor="Blue">Want registration information?</asp:Label>
			...
			<asp:Button id="RegistrationButton" style="Z-INDEX: 116; LEFT: 352px; POSITION: absolute; TOP: 368px"
				runat="server" Height="24px" Width="192px" Text="Click here for registration info"></asp:Button>
			<asp:Label id="lblSurvey" style="Z-INDEX: 117; LEFT: 168px; POSITION: absolute; TOP: 400px"
				runat="server" Height="24px" Width="448px" ForeColor="Blue">Users of Yield Prophet in 2004 are invited to take part in an online suvey</asp:Label>
			<asp:Button id="btnSurvey" style="Z-INDEX: 118; LEFT: 616px; POSITION: absolute; TOP: 400px"
				runat="server" Height="24px" Width="184px" Text="Click here for online survey"></asp:Button>
		</form>
	</body>
</HTML>
