...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<jwg:gridEX id="grdUsers" style="Z-INDEX: 101; LEFT: 24px; POSITION: absolute; TOP: 112px" runat="server"
			...
			<jwg:gridEX id="grdPaddocks" style="Z-INDEX: 102; LEFT: 464px; POSITION: absolute; TOP: 112px"
			...
			<asp:RadioButtonList id="RadioButtonList1" style="Z-INDEX: 103; LEFT: 312px; POSITION: absolute; TOP: 24px"
				runat="server" Width="240px" AutoPostBack="True" Height="48px">
				<asp:ListItem Value="stephen" Selected="True">Administrator</asp:ListItem>
				<asp:ListItem Value="harm">Consultant (harm)</asp:ListItem>
				<asp:ListItem Value="quinlan">Consultant (Richard Quinlan)</asp:ListItem>
			</asp:RadioButtonList>
			<asp:Label id="Label1" style="Z-INDEX: 104; LEFT: 376px; POSITION: absolute; TOP: 8px" runat="server">Mode</asp:Label>
			<asp:LinkButton id="btnAddUser" style="Z-INDEX: 105; LEFT: 48px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">Add User</asp:LinkButton>
			<asp:ImageButton id="btnAddUserImg" style="Z-INDEX: 106; LEFT: 24px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\growers.gif"></asp:ImageButton>
			<asp:ImageButton id="btnEditUserImg" style="Z-INDEX: 107; LEFT: 120px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\users_details.gif"></asp:ImageButton>
			<asp:LinkButton id="btnEditUser" style="Z-INDEX: 108; LEFT: 144px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">Edit User</asp:LinkButton>
			<asp:ImageButton id="btnViewReportsImg" style="Z-INDEX: 109; LEFT: 216px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\reports.gif"></asp:ImageButton>
			<asp:LinkButton id="btnViewReports" style="Z-INDEX: 110; LEFT: 240px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">View Reports</asp:LinkButton>
			<asp:ImageButton id="btnDeleteUserImg" style="Z-INDEX: 111; LEFT: 328px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\cancel.gif"></asp:ImageButton>
			<asp:LinkButton id="btnDeleteUser" style="Z-INDEX: 112; LEFT: 352px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">Delete User</asp:LinkButton>
			<asp:Label id="lblUsers" style="Z-INDEX: 113; LEFT: 176px; POSITION: absolute; TOP: 88px" runat="server">Users</asp:Label>
			<asp:Label id="lblPaddocks" style="Z-INDEX: 114; LEFT: 552px; POSITION: absolute; TOP: 88px"
				runat="server">Paddocks</asp:Label>
			<asp:ImageButton id="btnAddPaddockImg" style="Z-INDEX: 115; LEFT: 464px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\add.gif"></asp:ImageButton>
			<asp:LinkButton id="btnAddPaddock" style="Z-INDEX: 116; LEFT: 488px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">Add Paddock</asp:LinkButton>
			<asp:ImageButton id="btnEditPaddockImg" style="Z-INDEX: 117; LEFT: 584px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\paddock.gif"></asp:ImageButton>
			<asp:LinkButton id="btnEditPaddock" style="Z-INDEX: 118; LEFT: 608px; POSITION: absolute; TOP: 536px"
				runat="server" Font-Size="Smaller">Edit Paddock</asp:LinkButton>
			<asp:ImageButton id="btnDeletePaddockImg" style="Z-INDEX: 119; LEFT: 696px; POSITION: absolute; TOP: 528px"
				runat="server" ImageUrl="Images\cancel.gif"></asp:ImageButton>
			<asp:LinkButton id="btnDeletePaddock" style="Z-INDEX: 120; LEFT: 720px; POSITION: absolute; TOP: 536px"
