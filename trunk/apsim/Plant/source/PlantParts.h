...
class plantLeafPart : public plantPart {
  ...
  public: 
   ...
   void get_leaf_no_dead(protocol::Component *system, protocol::QueryValueData &qd);
   ...
   float gLeafNoDead[max_node];                       // no of dead leaves ()
  ...
  private:
   ...
   float dltLeafNoDead;                               // fraction of oldest green leaf senesced ()
